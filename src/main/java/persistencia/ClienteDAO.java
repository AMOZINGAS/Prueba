    ...
    public ClienteDTO editar(ClienteDTO clienteDTO) {
        ...
        try (Connection connection = conexionBD.crearConexion()) {
            ...
            try (PreparedStatement statement = connection.prepareStatement(sql)) {
                ...
                statement.setString(1, clienteDTO.getContrasenia());
                statement.setString(2, clienteDTO.getCorreo());
                statement.setString(3, clienteDTO.getNombres());
                statement.setString(4, clienteDTO.getApellidoPaterno());
                statement.setString(5, clienteDTO.getApellidoMaterno());
                statement.setString(6, clienteDTO.getCalle());
                statement.setString(7, clienteDTO.getColonia());
                statement.setString(8, clienteDTO.getCodigoPostal());
                statement.setInt(9, clienteDTO.getId());
